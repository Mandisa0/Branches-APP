function buyHealth(amount, cost) {
    ...
    LongToast.fire({
        title: toast + '<small style="color: tomato;margin:5px;font-size:10px"><strong>+</strong> <i class="fa fa-heart"></i> ' + amount + ' Health</small> <br>'
    });
...
function buyStrength(amount, cost) {
    ...
    LongToast.fire({
        title: toast + '<small style="color: burlywood;margin:5px;font-size:10px"><strong>+</strong> <i class="fa fa-hand-fist"></i> ' + amount + ' Strength</small> <br>'
    });
